...
<head>
  ...
  <link rel="stylesheet" href="<?= SITE_URL ?>/public/css/asura.css">
...
<div id="mobile-nav-drawer">
  ...
  <nav class="flex flex-col gap-1 p-3">
    <a href="<?= SITE_URL ?>/" class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?= $curPage==='home' ? 'bg-[#913FE2] text-white' : 'text-white/80 hover:bg-white/5 hover:text-white' ?> transition-colors">
    ...
    <a href="<?= SITE_URL ?>/browse" class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?= $curPage==='browse' ? 'bg-[#913FE2] text-white' : 'text-white/80 hover:bg-white/5 hover:text-white' ?> transition-colors">
  ...
  <div class="asura-header-inner mx-auto h-full w-full max-w-[1285px] px-3">
    <div class="flex items-center justify-between h-full">
      ...
      <div class="flex items-center gap-4 h-full">
        <!-- Logo -->
        <a href="<?= SITE_URL ?>/" aria-label="<?= SITE_NAME ?> Home" class="flex items-center gap-2 group">
        ...
        <nav class="asura-desktop-flex items-center gap-1 h-full">
          <a href="<?= SITE_URL ?>/" class="flex items-center justify-center px-3 py-2 rounded-md transition-colors hover:bg-black/20 <?= $curPage==='home' ? 'text-white font-semibold' : 'text-white/90 hover:text-white' ?>">
            <div>Home</div>
          </a>
          <a href="<?= SITE_URL ?>/browse" class="flex items-center justify-center px-3 py-2 rounded-md transition-colors hover:bg-black/20 <?= $curPage==='browse' ? 'text-white font-semibold' : 'text-white/90 hover:text-white' ?>">
            <div>Browse</div>
          </a>
        </nav>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="asura-desktop-block">
          <form action="<?= SITE_URL ?>/browse" method="get" role="search">
        ...
        <a href="<?= SITE_URL ?>/browse" class="asura-mobile-button p-2 rounded-md text-white/90 hover:text-white hover:bg-black/20 transition-colors" aria-label="Search">
      ...
      <div class="py-5">
        <div class="flex flex-col items-center gap-4 text-center">
          ...
          <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 font-medium text-sm">
            <a href="<?= SITE_URL ?>/"        class="text-white/70 hover:text-white transition-colors">Home</a>
            <a href="<?= SITE_URL ?>/browse"  class="text-white/70 hover:text-white transition-colors">Browse</a>
          </div>
        </div>
      </div>
    </div>
